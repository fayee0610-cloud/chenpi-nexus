// ============================================================
// /api/cron/fetch-intelligence — 东南亚实局自动抓取与生成
//
// 战略定位：陈皮垂直行业专家 IP
...
// ---------- 陈皮深度视角提炼 Prompt ----------
const SYSTEM_PROMPT = `你是一位专精于"东南亚市场与 AI 营销"的资深商业情报分析师。
请针对【新加坡、马来西亚、印尼、越南、泰国、菲律宾】等东南亚核心市场，生成/筛选最新的高价值商业情报。

【聚焦主题领域】：
1. 东南亚本土化营销与消费趋势（电商、食品美妆、3C、B2B 出海实局）；
2. AI 在跨境营销、多语种本地化、广告投放、自动化 Flow 中的创新落地；
3. 东南亚出海政策、渠道变局与品牌心智穿透实操战术。

【四大分类板块（category 仅能 4 选 1）】
1. \U0001f30f 东南亚实局：东南亚本土化营销动态、东盟市场GTM实战、跨境品牌出海案例与文化适配洞察
2. \U0001f916 AI 营销杠杆：AI 赋能营销流程、自动化工作流、AI 硬件/具身智能的商业化进展与场景应用
3. \U0001f3af 深度洞察：主流大厂/头部 AI 企业的技术演进、产品路线图、战略布局深度拆解
4. \U0001f4e6 战术拆解：ToB/ToC 营销、公关、社媒、GEO（生成式搜索引擎优化）等实战 GTM 战术与研究
...
[
  {
    ...
    "category": "\U0001f30f 东南亚实局" | "\U0001f916 AI 营销杠杆" | "\U0001f3af 深度洞察" | "\U0001f4e6 战术拆解",
    "source_name": "信息来源（如：机构报告 / 大厂发布 / 专家访谈）",
    "source_url": "原文/报告链接（真实可访问 URL）",
