  ...
  fortuneLibrary: {
    inspiration: {
      ...
      quotes: [
        ...
        "AI 不是替代你的想象力，而是放大你灵感的杠杆",
        "把限制当成创意的起跳板，约束越紧，破局越狠",
        "今天的不成熟脑洞，可能就是明天的颠覆式方案",
        "创意人的护城河：把别人眼中的废话，炼成金句",
        "赛博时代的灵感公式：好奇心 × 算力 × 人性洞察",
        "别等灵感来敲门，主动去敲打那些不相关的边界",
        "一个想法值多少钱？取决于你敢不敢把它说出来",
      ],
    },
    growth: {
      label: "破局焦虑",
      ...
      quotes: [
        "超级个体的壁垒：把碎片技能织成别人无法复制的网络",
        "增长杠杆的本质：找到那个能被无限放大的微小动作",
        "焦虑是免费的，但行动才是付费的入场券",
        "商业壁垒不是建出来的，是在实战中长出来的",
        "OPC 的核心能力：一个人就是一家公司，一个想法就是一次发射",
        "别和巨头拼资源，和巨头拼速度与反共识",
        "增长 hack 的前提：先有一个值得被 hack 的好产品",
        "今天的最优解，可能就是明天的天花板，保持迭代",
      ],
    },
    healing: {
      label: "赛博疗愈",
      ...
      quotes: [
        "情绪护城河：拒绝消耗你能量的人与事，是最高级的自律",
        "数字游民的自由，不是去哪儿，而是不去做什么",
        "下班后的断网，是对抗算法异化的最后防线",
        "允许自己偶尔低效，机器才需要 7×24 满载运转",
        "最好的疗愈，是把手机调成飞行模式，去散步",
        "你不是在拖延，你是在给潜意识留出整合的时间",
        "极客的浪漫：用代码构建秩序，用留白抵抗失控",
        "今天的你已完成 KPI：好好活着，没有被信息流淹没",
      ],
    },
  },
